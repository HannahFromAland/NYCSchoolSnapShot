...
Asian <- school %>%
  ...
  labs(title = "Interaction Between Asian Ethnicity and School Poverty",
...
Black <- school %>%
  ...
  labs(title = "Interaction Between Black Ethnicity and School Poverty",
       subtitle = "Overlay by School Total Enrollment") +
  theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 14),
        plot.subtitle = element_text(hjust = 0.5, face = "bold", size = 10))
  #geom_density_2d_filled(alpha = 0.5, show.legend = FALSE)
...
Hispanic <- school %>%
  ...
  labs(title = "Interaction Between Hispanic Ethnicity and School Poverty",
       subtitle = "Overlay by School Total Enrollment") +
  theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 14),
        plot.subtitle = element_text(hjust = 0.5, face = "bold", size = 10))
  #geom_density_2d_filled(alpha = 0.5, show.legend = FALSE)
...
White <- school %>%
  ...
  labs(title = "Interaction Between White Ethnicity and School Poverty",
       subtitle = "Overlay by School Total Enrollment") +
  theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 14),
        plot.subtitle = element_text(hjust = 0.5, face = "bold", size = 10))
  #geom_density_2d_filled(alpha = 0.5, show.legend = FALSE)
...
school %>%
  ...
  summarise(Asian = round(mean(Asian), 0),
            ...
            Others = round(mean(Others), 0),
            White = round(mean(White), 0),
            Male = round(mean(Male), 0),
            Female = round(mean(Female), 0))
```
