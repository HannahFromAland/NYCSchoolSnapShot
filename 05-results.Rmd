...
#   ggtitle("Poverty Boxplot") +
#   theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 14))
# Poverty
# 
# Enrollment <- school %>%
#   ggplot(mapping = aes(x = Total.Enrollment)) +
#   geom_boxplot(fill = "lightblue") +
#   ggtitle("Total Enrollment Boxplot") +
#   theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 14))
# Enrollment
...
Poverty.Enrollment <- school %>%
  ...
  scale_colour_gradient(low = "#F5B8FC", high = "#2E00FF") +
...
### Poverty Level vs Ethnic Composition

### Larger School, More balanced Ethnicity Group?

### Does Poverty Affect Gender Composition of Access to Education?
