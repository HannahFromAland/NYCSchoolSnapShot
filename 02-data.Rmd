...
* The data is presented in chronological order with each school having 5 observations (i.e. five academic years, including 2013-2014, 2014-2015, 2015-2016, 2016-2017, and 2017-2018). Given the goal of our project, time series data would complicate the analysis process. So, we need to aggregate the existing chronological observations.